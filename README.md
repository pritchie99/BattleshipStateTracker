...
**Extensibility**
	* Future extensibility will depend on the requirement at the time.  However this may involve splitting the state from the stgate configuration methods by use of a helper, extension, or abstract class.  A fine line whether implementing this sort of structure for an unknown feature request might offset the Reabability requirement above.
